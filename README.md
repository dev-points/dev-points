...
<h2>Summary</h2>
<b>Cybersecurity Analyst focused on defending organizations against modern cyber threats through SOC operations, vulnerability assessments, penetration testing (VAPT), and phishing analysis. My work centers on discovering security weaknesses, analyzing threat activity, and helping organizations reduce risk while maintaining strong security and compliance practices.

As an ISO/IEC 27001:2022 Lead Auditor, I also contribute to strengthening security governance by supporting organizations in implementing effective information security controls, managing risks, and aligning with international standards.

I’m driven by a curiosity to understand how attacks happen and how they can be prevented. By combining technical analysis with proactive defense strategies, I aim to improve the resilience of critical systems and digital infrastructure. I believe in continuous learning, building security-focused tools, and sharing knowledge with the cybersecurity community to help create a safer digital environment for everyone.</b>
